...
def normalised_data(records):
    ...
    for row in records:
        ...
        parsed_data = {
            ...
            # the rest of these need fixing in the case that they are missing, so add a check for each.
            "parent_variant_id": row.get("Parent_Plasmid_Variant") if row.get("Parent_Plasmid_Variant") is not None else None,
