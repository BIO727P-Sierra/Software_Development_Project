...
optional = [
    "Protein_Sequence", 
    "Protein_Quantification_fg", 
    "Control", 
    "Parent_Plasmid_Variant", 
]

# Load the file based on extension
def load_file(file_path): #Variable to be changed according to user upload page
...
def normalised_data(records):
    ...
    for row in records:
        ...
        parsed_data = {
            ...
            "protein_yield": float(row["Protein_Quantification_fg"]) if row.get("Protein_Quantification_fg") else None
        }
